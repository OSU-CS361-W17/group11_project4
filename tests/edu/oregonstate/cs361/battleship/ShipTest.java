...
class ShipTest {
    ...
    public void testPlaceShip() {
        Ship s = new Ship("AircraftCarrier",5, new Coordinate(5,2),new Coordinate(5,7),0);
        assertEquals(true,s.covers(new Coordinate(5,2)));
    }

    @Test
    public void testPlaceShipHorizontal() {
        Ship s = new Ship("AircraftCarrier",5, new Coordinate(5,2),new Coordinate(10,2),0);
    ...
    public void testPlaceShipVerticalNoLocation() {
        Ship s = new Ship("AircraftCarrier",5,new Coordinate(0,0),new Coordinate(9,9),0);
        assertEquals(false,s.covers(new Coordinate(1,1)));
    }
