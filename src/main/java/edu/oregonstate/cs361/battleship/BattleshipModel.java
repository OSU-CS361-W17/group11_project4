...
public class BattleshipModel {
    ...
    protected Ship battleship = new Ship("Battleship",4, new Coordinate(0,0),new Coordinate(0,0));
    protected Ship submarine = new Ship("Submarine",2, new Coordinate(0,0),new Coordinate(0,0));
    ...
    protected Ship computer_aircraftCarrier = new Ship("Computer_AircraftCarrier",5, new Coordinate(2,2),new Coordinate(2,7));
    protected Ship computer_battleship = new Ship("Computer_Battleship",4, new Coordinate(2,8),new Coordinate(6,8));
    protected Ship computer_submarine = new Ship("Computer_Submarine",2, new Coordinate(9,6),new Coordinate(9,8));
